...
namespace Service.Contracts.Services
{
    ...
    public interface IRESTTEMPLATEInternalApi
    {
        ...
        [WebGet(BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = RestUrls.RESTInternalHello, RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
